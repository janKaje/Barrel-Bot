...
> On the official Barrel Cult discord server (you need to be on [PlanetSmith](https://planetsmith.world/)'s server first)
...
Suggestions are always welcomed, there is a google form but since we are already on github, open an issue with the `enhancement` tag and describe your ideas!

# Plans for the future
- Redo parts of the bot to be able to run it on the PS server to bring minigames focused on the <img src="./github/img/barrel.png" alt="Barrel" height="15px"> there, we will have to get in touch with the admins to work things out etc...
